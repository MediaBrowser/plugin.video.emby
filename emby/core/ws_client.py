...
import threading
import time
import emby.core.websocket
LOG = logging.getLogger('Emby.core.ws_client')
...
class WSClient(threading.Thread):
    ...
    def run(self):
        ...
        self.wsc = emby.core.websocket.WebSocketApp(wsc_url, on_message=self.on_message, on_error=self.on_error)
